...
local callback = function()
  ...
  local config = {
    cmd = {
      ...
      "-configuration",
      jdtls_path .. "config_linux" .. OS_NAME,
      -- ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^        ^^^^^^
  ...
  keymap("n", "<leader>co", ":lua require'jdtls'.organize_imports()<cr>", { silent = true, buffer = bufnr })
  keymap("n", "<leader>rv", ":lua require'jdtls'.extract_variable()<cr>", { silent = true, buffer = bufnr })
  keymap("v", "<leader>rv", "<Esc>:lua require'jdtls'.extract_variable(true)<cr>", { silent = true, buffer = bufnr })
  keymap("n", "<leader>rc", ":lua require'jdtls'.extract_constant()<cr>", { silent = true, buffer = bufnr })
  keymap("v", "<leader>rc", "<Esc>:lua require'jdtls'.extract_constant(true)<cr>", { silent = true, buffer = bufnr })
  keymap("v", "<leader>rm", "<Esc>:lua require'jdtls'.extract_method(true)<cr>", { silent = true, buffer = bufnr })
